...
extension Refuel {
    ...
    static var data: [Refuel] {
        [
            ...
            Refuel(totalKM: 6215, liters: 4.59, money: 7.43, creationDate: Date(dateLiteralString: "2023-03-03"), kmAdded: 155),
            Refuel(totalKM: 6395, liters: 3.46, money: 6, creationDate: Date(dateLiteralString: "2023-06-24"), kmAdded: 177.6)
        ]
    }
}
